...
na_cols = ['Alley', 'BsmtQual', 'BsmtCond', 'Fence', 'PoolQC', 'BsmtExposure', 'BsmtFinType1', 'BsmtFinType2', 'FireplaceQu', 'GarageType', 'GarageFinish', 'GarageQual', 'GarageCond', 'MiscFeature']
for col in na_cols:
